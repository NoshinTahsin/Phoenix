...
import com.example.graphruntime.XYValue;
import com.jjoe64.graphview.GraphView;
import com.jjoe64.graphview.series.DataPoint;
import com.jjoe64.graphview.series.PointsGraphSeries;
import com.tabian.scatterplotdynamic.R;
        ...
        btnAddPt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!mX.getText().toString().equals("") && !mY.getText().toString().equals("") ){
                    ...
                    // x-axis e time thakbe partograph e
                    //so eikhane x er value input na niye device theke time nite hbe
                    //then oita plot korte hbe
                    double x = Double.parseDouble(mX.getText().toString());

                    //y er value input neyar bebosthao thakbe
                    //but voice input chaibe age
                    //speech to text conversion er por j string pabe oita k number e convert kore y e rakhte hobe
